              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Checkbox(splashRadius: 0,activeColor: Colors.blue[700],shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)),checkColor: Colors.blue[400],value: remember_me, onChanged:(newbool){setState(() {
                          remember_me = newbool;
                        }); }),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          InkWell(onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => Regestration_Form(),));
                  ...
                  Center(
                    child: Container(
                        ...
                        decoration: const BoxDecoration(
                            ...
                            color: Colors.white
                        ),child: const Text("Or Login With Account",style: TextStyle(color: Colors.grey),)
                    ),
                  ),
                ],
              ),
