...
Future getposts() async {
  await httpConnections.GetAllPostswithphotos();
}
             ...
             if(snapshot.hasData){
               return SingleChildScrollView(
                 child: Padding(
                   ...
                   child: list3.isEmpty ? Center(child: CircularProgressIndicator()) : Column(
                                   ...
                                   children: [
                                     ListTile(
                                       leading: Container(
                                           ...
                                           child: Image.network("${list3[index]["thumbnailUrl"]}")),
                                       title: InkWell(
                                           onTap: () {
                                             prov.postid = index;
                                             Navigator.push(
...
//                                           "${list3[index]["subtitle"]}",
                                       ...
                                       trailing: InkWell(
                                           ...
                                           onSecondaryTap: () {
                                             context
                                                 .read<Jobs>()
                                                 .Removefromsaved(snapshot.data?[index]);
                                             ScaffoldMessenger.of(context).showSnackBar(
                                                 const SnackBar(
                                       ...
                                       children: [
                                         RichText(
                                             text: TextSpan(children: [
                                               TextSpan(
                                                   text: "${snapshot.data?[index]["id"] + 1 *1000}",
//                                                   text: "${list3[index]["id"] + 1 * 1000}",
                                         ...
                                         MaterialButton(
                                           ...
                                           onPressed: () {
                                             prov.appliedjobid = snapshot.data?[index]["id"];
